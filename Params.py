...
def ParseArgs():
	...
	parser.add_argument('--block_num', default=4, type=int, help='number of hops in gcn precessing')
	...
	parser.add_argument('--num_head', default=2, type=int, help='Multihead number of transformer layer')
	parser.add_argument('--eigs_dim', default=64, type=int)
